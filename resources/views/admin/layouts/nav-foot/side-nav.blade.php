...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if($authUser === UserRoleEnums::ADMIN->value)
            ...
            <li class="nav-item">
                <a class="nav-link {{is_active_route(['activities', 'admin.notifications.config', 'admin.sso.providers.index', 'admin.data-retention.index', 'admin.data-retention.policies.update', 'admin.data-retention.dry-run', 'admin.data-retention.run', 'admin.system-health.index'])}}"
                   data-bs-target="#settings_page" data-bs-toggle="collapse" href="#">
                    <i class="bi {{is_active_route_val(['activities', 'admin.notifications.config', 'admin.sso.providers.index', 'admin.data-retention.index', 'admin.data-retention.policies.update', 'admin.data-retention.dry-run', 'admin.data-retention.run', 'admin.system-health.index'], 'bi-gear-wide-connected active', 'bi-gear-wide-connected')}}"></i>
                    <span>Settings</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="settings_page" class="nav-content collapse {{is_active_route_val(['activities', 'admin.notifications.config', 'admin.sso.providers.index', 'admin.data-retention.index', 'admin.data-retention.policies.update', 'admin.data-retention.dry-run', 'admin.data-retention.run', 'admin.system-health.index'], 'show', '')}}" data-bs-parent="#sidebar-nav">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.data-retention.index') }}" class="{{is_active_route(['admin.data-retention.index', 'admin.data-retention.policies.update', 'admin.data-retention.dry-run', 'admin.data-retention.run'])}}">
                            <i class="bi bi-circle"></i><span>Data Retention</span>
                        </a>
                    </li>
                    <li>
